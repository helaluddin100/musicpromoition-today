...
const Page9 = () => {
  return (
    <div id="page9">
            ...
            <div className="col">
              <div className="banner-content">
                ...
                <h1 className="banner-title">
                  In to Your <span className="focus">Creative</span> Process
                </h1>
                <p className="banner-des">
                  You'll get the attention you deserve with our powerful writing
                  team behind you. They’ve written biographies for some of the
                  biggest names in music, so they know exactly what it takes to
                  make an impact
                </p>
            ...
            <div className="col">
              <div className="banner-right">
                <div className="animated ban-a">
                  <img src="/assets/home-9/img/1.png" alt="" />
                </div>
              </div>
            </div>
          </div>
      ...
      <ServiceSection type="nine" />
      <VisionSection type="nine" />
      <AboutSection type="nine" />
      <PricingSection data={pricingData} type="nine" />
      <ImageSection />
      <FeatureSection data={videoData} color="#6E8DF8" />
      <EngageSection />
      <VideoIntroSection type="nine" />
      <FaqSection />
      <ReviewSection type="nine" />
    </div>
  );
};
...
Page9.title = "Music Promotion Home";
Page9.layout = AppLayout;
